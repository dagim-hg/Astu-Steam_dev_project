        ...
        <div className="bg-gray-50 dark:bg-slate-950 min-h-screen transition-colors duration-300">
            ...
            <section className="relative min-h-[90vh] flex items-center py-20 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img 
                        src="https://imgs.search.brave.com/OG4RUIKeNqsHC3oBSJGT4fKSaABgZdoBFg_X5Bzsa9Q/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZS5mcmVlLWFwcGx5/LmNvbS9nYWxsZXJ5/L2wvdW5p/L2dhbGxl/cnkvbGcvMTAyMzEw/MDAyMC84M2Y4M2Ji/N2VhN2RkZWQzYWQ0/Mjk2MmNlOGI0ZWM5/MzE0Y2RiOGI0Lmpw/Zz9zPTY0MA" 
                        alt="ASTU Campus" 
                        className="w-full h-full object-cover"
                    />
                    {/* Light overlay: extremely light to show background */}
                    <div className="absolute inset-0 bg-white/30 dark:hidden"></div>
                    {/* Dark overlay: balanced for visibility and readability */}
                    <div className="absolute inset-0 hidden dark:block bg-slate-950/50 transition-opacity"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-gray-900 dark:text-white text-lg">ASTU Smart System v1.0</span>
                        </div>
                        <div className="flex flex-wrap items-center justify-center gap-8 text-sm font-medium text-gray-600 dark:text-slate-400">
                            <span>© 2026 Adama Science and Technology University</span>
                            <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 rounded-full border border-gray-100 dark:border-slate-700">
                                <ShieldCheck size={16} className="text-green-600 dark:text-green-400" />
                                <span>Secured by Campus Protocol</span>
                            </div>
                        </div>
                    </div>
                </div>
